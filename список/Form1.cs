...
namespace список
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show(Message.ExitRequest1, "Боги", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        ...
        {
            MessageBox.Show(Message.ExitRequest2,"Упс",MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
